...
def main():
    ...
    rna_data = TranscriptomeDataset.from_saved_file(args.path_to_transcriptome, genes=['EPCAM', 'COL3A1', 'CD3E', 'PLVAP', 'C1QA', 'IL1B', 'MS4A1', 'CD79A'])
    histo_data = TCGAFolder.match_transcriptome_data(rna_data)
    histo_data.transform = ToTensor()
    print("length of dataset..................", len(histo_data))
